...
// ✅ ENHANCED QUERY: Include more student details and resume information
$user_query = "
    SELECT u.id, u.username, u.full_name, u.email, u.phone, u.status, u.created_at, u.updated_at,
           ...
           CASE 
               WHEN r.role_name = 'Student' THEN sp.experience
               ELSE NULL
           END as student_experience,
           CASE 
               WHEN r.role_name = 'Student' THEN sp.resume_path
               ELSE NULL
           END as student_resume,
           CASE 
               WHEN r.role_name = 'Student' THEN sp.portfolio_url
               ELSE NULL
           END as student_portfolio,
           CASE 
               WHEN r.role_name = 'Student' THEN sp.linkedin_url
               ELSE NULL
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="user-details-section">
            ...
            <!-- ✅ ENHANCED: Student Educational Information -->
            ...
            <div class="detail-card" style="margin-bottom: 2rem;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem;">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">
                            <?php echo nl2br(htmlspecialchars($user['student_education'])); ?>
                        </div>
                    </div>
                    <?php endif; ?>

                    <?php if ($user['student_experience']): ?>
                    <div class="detail-item">
                        <div class="detail-label">Work Experience</div>
                        <div class="detail-value">
                            <?php echo nl2br(htmlspecialchars($user['student_experience'])); ?>
                        </div>
                    </div>
                    <?php endif; ?>

                    <?php if ($user['student_portfolio']): ?>
                    <div class="detail-item">
                        <div class="detail-label">Portfolio</div>
                        <div class="detail-value">
                            <a href="<?php echo htmlspecialchars($user['student_portfolio']); ?>" target="_blank" style="color: #3b82f6; text-decoration: none;">
                                <?php echo htmlspecialchars($user['student_portfolio']); ?>
                                <i class="fas fa-external-link-alt" style="margin-left: 0.5rem; font-size: 0.8rem;"></i>
                            </a>
                        </div>
                    </div>
                    ...
                    <?php if ($user['student_linkedin']): ?>
                    <div class="detail-item">
                        <div class="detail-label">LinkedIn Profile</div>
                        <div class="detail-value">
                            <a href="<?php echo htmlspecialchars($user['student_linkedin']); ?>" target="_blank" style="color: #3b82f6; text-decoration: none;">
                                <?php echo htmlspecialchars($user['student_linkedin']); ?>
                                <i class="fab fa-linkedin" style="margin-left: 0.5rem; color: #0077b5;"></i>
                            </a>
                        </div>
                    </div>
                    <?php endif; ?>
                ...
                <?php if (!$user['student_skills'] && !$user['student_education'] && !$user['student_bio'] && !$user['student_resume']): ?>
